(function () {
    ...
    angular.module('welpCAD').directive('editDesignModal', function($rootScope){
      return {
        ...
        controller: function($scope) {
          ...
          $scope.$on('edit-design-open', function(event, args) {
            $scope.open = true;
          });
